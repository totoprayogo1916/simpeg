  ...
  <div class="well">
	<div class="navbar navbar-inverse">
	  <div class="navbar-inner">
		...
		<?= form_open('laporan_pegawai_status_golongan/set', 'class="navbar-form pull-right"')
        ?>
		...
		<div class="span4 pull-right">
  		<a class="btn" href="<?= base_url(); ?>laporan_pegawai_status_golongan/export"><i class="icon-ok-circle"></i> Export ke Excell</a>
