  ...
  <div class="well">
	<div class="navbar navbar-inverse">
	  <div class="navbar-inner">
		...
		<?= form_open('laporan_pegawai_ikut_pelatihan/set', 'class="navbar-form pull-right"');
        ?>
		...
		<div class="span4 pull-right">
  		<a class="btn" href="<?= base_url(); ?>laporan_pegawai_ikut_pelatihan/export"><i class="icon-ok-circle"></i> Export ke Excell</a>
  ...
  <table class="table table-hover table-condensed">
	...
	<?php
      ...
      <tr>
        ...
        <td><?= $dp['tanggal_sertifikat']; ?></td>
        <td><?= $dp['jam_pelatihan']; ?></td>
      </tr>
	 <?php
            $no++;
        }
