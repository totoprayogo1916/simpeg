  ...
  <div class="well">
	<div class="navbar navbar-inverse">
	  <div class="navbar-inner">
		...
		<?= form_open('laporan_pegawai_penempatan_kerja/set', 'class="navbar-form pull-right"');
        ?>
			...
			<option value="">- Lokasi Kerja -</option>
			  	<?php
                    foreach ($mst_lokasi_kerja->result_array() as $muk) {
                        if (session('id_lokasi_kerja') === $muk['id_lokasi_kerja']) {
                            ?>
			  		<option value="<?= $muk['id_lokasi_kerja']; ?>" selected="selected"><?= $muk['lokasi_kerja']; ?></option>
			  	<?php
                        } else {
                            ?>
			  		<option value="<?= $muk['id_lokasi_kerja']; ?>"><?= $muk['lokasi_kerja']; ?></option>
			  	<?php
                        }
                    }
                ?>
		...
		<div class="span4 pull-right">
  		<a class="btn" href="<?= base_url(); ?>laporan_pegawai_penempatan_kerja/export"><i class="icon-ok-circle"></i> Export ke Excell</a>
