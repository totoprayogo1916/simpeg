  ...
  <div class="well">
	<div class="navbar navbar-inverse">
	  <div class="navbar-inner">
		...
		<?= form_open('laporan_pegawai_urut_kepangkatan/set', 'class="navbar-form pull-right"');
        ?>
			...
			<option value="">- Status Pegawai -</option>
			  	...
			  	<?php
                            ...
                            ?>
			  		<option value="<?= $msk['id_status_pegawai']; ?>"><?= $msk['nama_status']; ?></option>
			  	<?php
                        }
                    }
                ?>
			...
			<option value="">- Golongan -</option>
			  	<?php
                    foreach ($mst_golongan->result_array() as $msk) {
                        if (session('id_gol_awal') === $msk['id_golongan']) {
                            ?>
			  		<option value="<?= $msk['id_golongan']; ?>" selected="selected"><?= $msk['golongan']; ?></option>
			  	<?php
                        } else {
                            ?>
			  		<option value="<?= $msk['id_golongan']; ?>"><?= $msk['golongan']; ?></option>
			  	<?php
                        }
                    }
                ?>
			...
			<option value="">- Golongan -</option>
			  	<?php
                    foreach ($mst_golongan->result_array() as $msk) {
                        if (session('id_gol_akhir') === $msk['id_golongan']) {
                            ?>
			  		<option value="<?= $msk['id_golongan']; ?>" selected="selected"><?= $msk['golongan']; ?></option>
			  	<?php
                        } else {
		...
		<div class="span4 pull-right">
  		<a class="btn" href="<?= base_url(); ?>laporan_pegawai_urut_kepangkatan/export"><i class="icon-ok-circle"></i> Export ke Excell</a>
