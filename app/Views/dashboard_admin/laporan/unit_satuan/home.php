  ...
  <div class="well">
	<div class="navbar navbar-inverse">
	  <div class="navbar-inner">
		...
		<?= form_open('laporan_pegawai_unit_satuan/set', 'class="navbar-form pull-right"')
        ?>
			<div class="span2"><strong>Unit Kerja</strong></div>
			<div class="span">:</div>
			<div class="span3">
			 <select class="span3" name="id_unit_kerja">
			<option value="">- Unit Kerja -</option>
			  	<?php
                    foreach ($mst_unit_kerja->result_array() as $muk) {
                        if (session('id_unit_kerja') === $muk['id_unit_kerja']) {
                            ?>
		...
		<a class="btn" href="<?= base_url(); ?>laporan_pegawai_unit_satuan/export"><i class="icon-ok-circle"></i> Export ke Excell</a>
