...
<html lang="en">
  ...
  <div class="well">
	<div class="navbar navbar-inverse">
	  <div class="navbar-inner">
		<div class="container">
		  <a class="brand" href="#">Master Golongan</a>
		  <div class="nav-collapse">
			<ul class="nav">
			  <li><a href="<?= base_url(); ?>master_golongan/tambah" class="small-box"><i class="icon-plus-sign icon-white"></i> Tambah Golongan</a></li>
			</ul>
		  </div>
		<div class="span6 pull-right">
		<?= form_open('master_golongan/cari', 'class="navbar-form pull-right"'); ?>
  ...
  <table class="table table-hover table-condensed">
	...
	<?php
      ...
      <tr>
		...
		<td>
	        <div class="btn-group">
	          <a class="btn btn-small small-box" href="<?= base_url(); ?>master_golongan/detail/<?= $dp['id_golongan']; ?>"><i class="icon-ok-circle"></i> Lihat Detail</a>
	          <a class="btn btn-small dropdown-toggle" data-toggle="dropdown" href="#"><span class="caret"></span></a>
	          <ul class="dropdown-menu">
	            <li><a href="<?= base_url(); ?>master_golongan/edit/<?= $dp['id_golongan']; ?>" class="small-box"><i class="icon-pencil"></i> Edit Data</a></li>
	            <li><a href="<?= base_url(); ?>master_golongan/hapus/<?= $dp['id_golongan']; ?>" onClick="return confirm('Anda yakin..???');"><i class="icon-trash"></i> Hapus Data</a></li>
	          </ul>
	        </div><!-- /btn-group -->
		</td>
      </tr>
