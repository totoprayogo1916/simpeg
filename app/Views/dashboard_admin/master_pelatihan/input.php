...
<html lang="en">
  ...
  <body>
	...
	<?php } ?>
		<?= form_open('master_pelatihan/simpan', 'class="form-horizontal"'); ?>
		  <div class="control-group">
		  	<legend>Master Pelatihan</legend>
			<label class="control-label" for="nama_pelatihan">Nama Pelatihan</label>
			<div class="controls">
			  <input type="text" class="span" name="nama_pelatihan" id="nama_pelatihan" value="<?= $nama_pelatihan; ?>" placeholder="Nama Pelatihan">
			</div>
		  </div>
		  <div class="control-group">
