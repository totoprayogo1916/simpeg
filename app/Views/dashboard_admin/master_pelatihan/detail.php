...
<html lang="en">
  ...
  <body>
	<div class="well">
		<?= form_open('master_eselon/simpan', 'class="form-horizontal"'); ?>
		  <div class="control-group">
		  	<legend>Master Pelatihan</legend>
			<label class="control-label" for="nama_pelatihan">Nama Pelatihan</label>
			<div class="controls">
			  <input type="text" class="span" name="nama_pelatihan" id="nama_pelatihan" value="<?= $nama_pelatihan; ?>" disabled placeholder="Nama Pelatihan">
			</div>
		  </div>
		  <div class="control-group">
			<label class="control-label" for="level">Level</label>
			<div class="controls">
			  <input type="text" class="span" name="level" id="level" value="<?= $level; ?>" disabled placeholder="Level">
			</div>
		  </div>
		<?= form_close(); ?>
	</div>
