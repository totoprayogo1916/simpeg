...
<html lang="en">
  ...
  <body>
	...
	<?php } ?>
		<?= form_open('master_jabatan/simpan', 'class="form-horizontal"'); ?>
		  <div class="control-group">
		  	<legend>Master Jabatan</legend>
			<label class="control-label" for="nama_jabatan">Nama Jabatan</label>
			<div class="controls">
			  <input type="text" class="span" name="nama_jabatan" id="nama_jabatan" value="<?= $nama_jabatan; ?>" placeholder="Nama Jabatan">
			</div>
		  </div>
		  <div class="control-group">
