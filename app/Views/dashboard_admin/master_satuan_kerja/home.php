	  ...
	  <div class="navbar-inner">
		<div class="container">
		  ...
		  <div class="nav-collapse">
			<ul class="nav">
			  <li><a href="<?= base_url(); ?>master_satuan_kerja/tambah" class="small-box"><i class="icon-plus-sign icon-white"></i> Tambah Satuan Kerja</a></li>
			</ul>
		  </div>
		<div class="span6 pull-right">
		<?= form_open('master_satuan_kerja/cari', 'class="navbar-form pull-right"'); ?>
  ...
  <table class="table table-hover table-condensed">
	...
	<?php
      ...
      <tr>
        ...
        <td><?= $dp['parent_unit']; ?></td>
		<td>
	        <div class="btn-group">
	          <a class="btn btn-small small-box" href="<?= base_url(); ?>master_satuan_kerja/detail/<?= $dp['id_satuan_kerja']; ?>"><i class="icon-ok-circle"></i> Lihat Detail</a>
	          <a class="btn btn-small dropdown-toggle" data-toggle="dropdown" href="#"><span class="caret"></span></a>
	          <ul class="dropdown-menu">
	            <li><a href="<?= base_url(); ?>master_satuan_kerja/edit/<?= $dp['id_satuan_kerja']; ?>" class="small-box"><i class="icon-pencil"></i> Edit Data</a></li>
	            <li><a href="<?= base_url(); ?>master_satuan_kerja/hapus/<?= $dp['id_satuan_kerja']; ?>" onClick="return confirm('Anda yakin..???');"><i class="icon-trash"></i> Hapus Data</a></li>
	          </ul>
	        </div><!-- /btn-group -->
		</td>
      </tr>
