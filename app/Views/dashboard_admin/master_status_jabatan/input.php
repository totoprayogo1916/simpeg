...
<html lang="en">
  ...
  <body>
	...
	<?php } ?>
		<?= form_open('master_status_jabatan/simpan', 'class="form-horizontal"'); ?>
		  <div class="control-group">
		  	<legend>Master Status Jabatan</legend>
			<label class="control-label" for="nama_jabatan">Nama Status Jabatan</label>
			<div class="controls">
			  <input type="text" class="span" name="nama_jabatan" id="nama_jabatan" value="<?= $nama_jabatan; ?>" placeholder="Nama Status Jabatan">
			</div>
		  </div>
