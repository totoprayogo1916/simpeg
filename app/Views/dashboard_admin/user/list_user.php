	  ...
	  <div class="navbar-inner">
		<div class="container">
		  ...
		  <div class="nav-collapse">
			<ul class="nav">
			  <li><a href="<?= base_url(); ?>manage_user/tambah" class="small-box"><i class="icon-plus-sign icon-white"></i> Tambah User</a></li>
			</ul>
		  </div>
		</div>
	  </div><!-- /navbar-inner -->
  ...
  <table class="table table-hover table-condensed">
	...
	<?php
      ...
      <tr>
		...
		<td>
	        <div class="btn-group">
	          <a class="btn btn-small small-box" href="<?= base_url(); ?>manage_user/detail/<?= $dp['id_user_login']; ?>"><i class="icon-ok-circle"></i> Lihat Detail</a>
	          <a class="btn btn-small dropdown-toggle" data-toggle="dropdown" href="#"><span class="caret"></span></a>
	          <ul class="dropdown-menu">
	            <li><a href="<?= base_url(); ?>manage_user/edit/<?= $dp['id_user_login']; ?>" class="small-box"><i class="icon-pencil"></i> Edit Data</a></li>
	            <li><a href="<?= base_url(); ?>manage_user/hapus/<?= $dp['id_user_login']; ?>" onClick="return confirm('Anda yakin..???');"><i class="icon-trash"></i> Hapus Data</a></li>
	          </ul>
	        </div><!-- /btn-group -->
		</td>
      </tr>
