...
<html lang="en">
  ...
  <body>
	<div class="well">
		<?= form_open('master_lokasi_kerja/simpan', 'class="form-horizontal"'); ?>
		  <div class="control-group">
		  	<legend>Master Lokasi Pelatihan</legend>
			<label class="control-label" for="nama_lokasi">Nama Lokasi Kerja</label>
			<div class="controls">
			  <input type="text" class="span" name="nama_lokasi" id="nama_lokasi" value="<?= $lokasi_kerja; ?>" placeholder="Nama Lokasi Kerja" disabled>
			</div>
		  </div>
		<?= form_close(); ?>
	</div>
