...
<html lang="en">
  ...
  <body>
	...
	<?php } ?>
		<?= form_open('data_gaji_pokok/simpan', 'class="form-horizontal"'); ?>
		  ...
		  <div class="control-group">
			...
			<div class="controls">
			  <input type="text" class="span6" name="dasar_perubahan" id="dasar_perubahan" value="<?= $dasar_perubahan; ?>"
		  ...
		  <div class="control-group">
			...
			<div class="controls">
			  <input type="text" class="span6" name="gaji_pokok" id="gaji_pokok" value="<?= $gaji_pokok; ?>"
