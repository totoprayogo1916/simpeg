	...
	<div class="well">
		...
		<div class="control-group">
		 <legend>Master Golongan</legend>
			...
			<div class="controls">
			  <input type="text" class="span" name="golongan" id="golongan" value="<?= $golongan; ?>" placeholder="Golongan" disabled>
			</div>
		  </div>
		  <div class="control-group">
			<label class="control-label" for="uraian">Uraian</label>
			<div class="controls">
			  <textarea class="span" name="uraian" id="uraian" style="resize:none; outline:none; height:100px;" placeholder="Uraian" disabled><?= $uraian; ?></textarea>
			</div>
		  </div>
		  <div class="control-group">
			<label class="control-label" for="level">Level</label>
			<div class="controls">
			  <input type="text" class="span" name="level" id="level" value="<?= $level; ?>" placeholder="Level" disabled>
			</div>
		  </div>
		<?= form_close(); ?>
	</div>
