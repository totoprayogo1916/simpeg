	  ...
	  <div class="navbar-inner">
		<div class="container">
		  ...
		  <div class="nav-collapse">
			<ul class="nav">
			  <li><a href="<?= base_url(); ?>master_eselon/tambah" class="small-box"><i class="icon-plus-sign icon-white"></i> Tambah Data Eselon</a></li>
			</ul>
		  </div>
		<div class="span6 pull-right">
		<?= form_open('master_eselon/cari', 'class="navbar-form pull-right"'); ?>
  ...
  <table class="table table-hover table-condensed">
	...
	<?php
      ...
      <tr>
		...
		<td>
	        <div class="btn-group">
	          <a class="btn btn-small small-box" href="<?= base_url(); ?>master_eselon/detail/<?= $dp['id_eselon']; ?>"><i class="icon-ok-circle"></i> Lihat Detail</a>
	          <a class="btn btn-small dropdown-toggle" data-toggle="dropdown" href="#"><span class="caret"></span></a>
	          <ul class="dropdown-menu">
	            <li><a href="<?= base_url(); ?>master_eselon/edit/<?= $dp['id_eselon']; ?>" class="small-box"><i class="icon-pencil"></i> Edit Data</a></li>
	            <li><a href="<?= base_url(); ?>master_eselon/hapus/<?= $dp['id_eselon']; ?>" onClick="return confirm('Anda yakin..???');"><i class="icon-trash"></i> Hapus Data</a></li>
	          </ul>
	        </div><!-- /btn-group -->
		</td>
      </tr>
