	...
	<?php } ?>
		<?= form_open('manage_user/simpan', 'class="form-horizontal"'); ?>
		  <div class="control-group">
			...
			<div class="controls">
			  <input type="text" class="span" name="nama_lengkap" id="nama_lengkap" value="<?= $nama_lengkap; ?>" readonly="true" placeholder="Nama Pengguna">
			</div>
		  </div>
		  <div class="control-group">
			<label class="control-label" for="eselon">Username</label>
			<div class="controls">
			  <input type="text" class="span" name="username" id="username" value="<?= $username; ?>" readonly="true" placeholder="Username">
			</div>
		  </div>
