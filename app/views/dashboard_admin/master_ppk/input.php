	...
	<?php } ?>
		<?= form_open('master_ppk/simpan', 'class="form-horizontal"'); ?>
		  <div class="control-group">
			...
			<div class="controls">
			  <input type="text" class="span" name="nama_unit_kerja" id="nama_unit_kerja" value="<?= $nama_unit_kerja; ?>" placeholder="Nama PPK">
			</div>
		  </div>
		  <div class="control-group">
			<label class="control-label" for="parent_unit">Parent Satuan Kerja</label>
			<div class="controls">
			  <input type="text" class="span" name="parent_unit" id="parent_unit" value="<?= $parent_unit; ?>" placeholder="Parent Satuan Kerja">
			</div>
		  </div>
