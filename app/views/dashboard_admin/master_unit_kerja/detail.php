	...
	<div class="well">
		<?= form_open('master_status_pegawai/simpan', 'class="form-horizontal"'); ?>
		  <div class="control-group">
			...
			<div class="controls">
			  <input type="text" class="span" name="nama_unit_kerja" id="nama_unit_kerja" disabled  value="<?= $nama_unit_kerja; ?>" placeholder="Nama Unit Kerja">
			</div>
		  </div>
		  <div class="control-group">
			<label class="control-label" for="eselon">Eselon</label>
			<div class="controls">
			  <input type="text" class="span" name="eselon" id="eselon" disabled  value="<?= $eselon; ?>" placeholder="Eseleon">
			</div>
		  </div>
		  <div class="control-group">
			<label class="control-label" for="parent_unit">Parent Unit</label>
			<div class="controls">
			  <input type="text" class="span" name="parent_unit" id="parent_unit" disabled  value="<?= $parent_unit; ?>" placeholder="Parent Unit">
			</div>
		  </div>
		<?= form_close(); ?>
	</div>
