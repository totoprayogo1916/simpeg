...
<html lang="en">
  ...
  <body>
	...
	<?php } ?>
		<?= form_open('master_penghargaan/simpan', 'class="form-horizontal"'); ?>
		  <div class="control-group">
		  	<legend>Master Penghargaan</legend>
			<label class="control-label" for="nama_penghargaan">Nama Penghargaan</label>
			<div class="controls">
			  <input type="text" class="span" name="nama_penghargaan" id="nama_penghargaan" value="<?= $nama_penghargaan; ?>" placeholder="Nama Penghargaan">
			</div>
		  </div>
